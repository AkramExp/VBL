...
import { FixturesAdminTable } from "./FixturesAdminTable";
...
interface FixtureManagerProps {
  ...
  stages: Stage[];
  getFixtures: () => void;
  fixtures: Fixture[]; // Add this prop
}

export function FixtureManager({ teams, stages, getFixtures, fixtures }: FixtureManagerProps) {
  ...
  const handleAddFixture = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Failed to add fixture. Please try again.",
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow-card">
        ...
        <CardContent>
          {teams.length < 2 || stages.length === 0 ? (
            ...
            <form onSubmit={handleAddFixture} className="space-y-4">
              ...
              <Button
                ...
                disabled={!selectedStage || !team1 || !team2}
              >
